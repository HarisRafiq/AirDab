...
#import "CircleCell_IPad.h"

@implementation CircleCell_IPad
    ...
    if (self) {
     ...
     mImageLayer.shouldRasterize = YES;
      mImageLayer.rasterizationScale=[[UIScreen mainScreen] scale];
        ...
        [mImageLayer setBackgroundColor:[UIColor blackColor].CGColor];
                ...
                mCellTtleLabel.font =[UIFont fontWithName:@"Helvetica-Bold" size:14];
        ...
        [mCellTtleLabel setBackgroundColor:[UIColor blackColor]];
...
-(void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    mImageLayer.borderColor = selected ? [UIColor colorWithRed:0.8 green:.0 blue:.0 alpha:1.0].CGColor:[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0].CGColor ;
    mCellTtleLabel.textColor = selected ?  [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.0] :[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0] ;
