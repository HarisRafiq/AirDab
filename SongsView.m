...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(!isLocalFile){
        [self.delegate addSelectedSongView:(SongsCell *)[tView cellForRowAtIndexPath:indexPath] AtScrollPosition:[tView contentOffset]];
        ...
        url=nil;
        [[AudioPlayer sharedInstance] setCurrentArtwork:[UIImage imageNamed:@"wave-black.png"]];
        
        [[AudioPlayer sharedInstance] setCurrentArtist:@"LOCAL"];
        [[AudioPlayer sharedInstance] setCurrentSongTotalDuration:c.duration.text];

    [self.delegate addSelectedSongView:c AtScrollPosition:[tView contentOffset]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SongsCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (cell == nil)
    {
        cell = [[SongsCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
    NSString *songTitle;
    NSString *duration;
    if(!isLocalFile){
